...
(function () {
  ...
  function renderOverview() {
    ...
    // Dải KPI "trực tiếp" (cộng dồn realtime từ DB) — chỉ hiện khi nạp qua mockapi.
    // Bản legacy đọc data tĩnh nên thường không có liveKpis → dải tự ẩn.
  ...
  function selectFamilyLink(id) {
    ...
    // Hành động theo trạng thái — không có nút nào cho phép guardian/admin thao tác tiền dependent.
  ...
  function setupActions() {
    ...
    $("#fam-search") && $("#fam-search").addEventListener("input", (e) => { state.familySearch = e.target.value; renderFamilyTable(); });
